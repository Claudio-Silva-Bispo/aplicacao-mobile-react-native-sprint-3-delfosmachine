...
const ClientBenefitsProgram = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <CustomButton title="conheça as atividades" onPress={() => router.push("/clientBenefitActivities")} width={'100%'} textColor='#fff'/>
...
export default ClientBenefitsProgram;