...
const RegisterClientShift: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
          ...
          <TouchableOpacity onPress={() => router.push("/programBenefits")} style={styles.nextButton}>
            <Text style={styles.buttonText}>→ Conheça o programa</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() =>  router.push("/registerClientDayPreference")} style={styles.prevButton}>
...
export default RegisterClientShift;