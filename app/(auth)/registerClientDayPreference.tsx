...
const RegisterClientDayPreference: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
          ...
          <TouchableOpacity onPress={() => router.push("/(auth)/registerClientShift")} style={styles.nextButton}>
            <Text style={styles.buttonText}>→ Próximo</Text>
          </TouchableOpacity>
          
          <TouchableOpacity onPress={() => router.push("/registerClientAddressPreference")} style={styles.prevButton}>
...
export default RegisterClientDayPreference;