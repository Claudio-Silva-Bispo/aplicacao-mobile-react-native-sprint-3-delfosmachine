...
const AppointmentsClient: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const fetchAgendamentos = async () => {
    try {
      ...
      if (docSnap.exists()) {
        const agendamentosData = docSnap.data().agendamentos;
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <CustomButton
        title="Voltar"
        onPress={() => router.push('/restrictedSessionClient')}
        width="100%"
        textColor="#fff"
      />
    </ScrollView>
