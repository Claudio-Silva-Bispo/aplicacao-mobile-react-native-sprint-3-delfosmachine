...
const RegisterClientAddressPreference: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
          ...
          <TouchableOpacity onPress={() => router.push("/registerClientDayPreference")} style={styles.nextButton}>
            <Text style={styles.buttonText}>→ Próximo</Text>
          </TouchableOpacity>
          
          <TouchableOpacity onPress={() => router.push("/registerPersonalInfo")} style={styles.prevButton}>
...
export default RegisterClientAddressPreference;