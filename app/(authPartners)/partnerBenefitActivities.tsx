...
//const AtividadesProgramaBeneficioClienteScreen = () => {
  const PartnerBenefitActivities: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <CustomButton title="Conheça as Recompensas" onPress={() => router.push("/clientBenefitsProgram")} width={"100%"} textColor="#fff" />
      </View>

      <View style={styles.buttonContainer}>
        <CustomButton title="Home" onPress={() => router.push("/restrictedSessionClient")} width={"100%"} textColor="#fff" backgroundColor="#f28705"/>
      </View>
...
export default PartnerBenefitActivities;